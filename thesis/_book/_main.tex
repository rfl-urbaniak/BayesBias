...
\NormalTok{religion}\OperatorTok{$}\NormalTok{wordClass <-}\StringTok{ }\KeywordTok{mapvalues}\NormalTok{(religion}\OperatorTok{$}\NormalTok{wordClass, }\DataTypeTok{from =} \KeywordTok{levels}\NormalTok{(religion}\OperatorTok{$}\NormalTok{wordClass), }\DataTypeTok{to =} \KeywordTok{c}\NormalTok{(}\StringTok{"christian"}\NormalTok{,}\StringTok{"human"}\NormalTok{,}\StringTok{"jewish"}\NormalTok{,}\StringTok{"muslim"}\NormalTok{,}\StringTok{"neutral"}\NormalTok{))}
\CommentTok{#levels(religion$wordClass) <- c("christian","human","jewish","muslim","neutral")}
\KeywordTok{head}\NormalTok{(religion)  }\OperatorTok{%>%}\StringTok{  }\KeywordTok{kable}\NormalTok{(}\DataTypeTok{format =} \StringTok{"latex"}\NormalTok{,}\DataTypeTok{booktabs=}\NormalTok{T,}
                      \DataTypeTok{linesep =} \StringTok{""}\NormalTok{,  }\DataTypeTok{escape =} \OtherTok{FALSE}\NormalTok{, }
