...
- Introduction to the topic of bias in word embeddings
- Analysis of methodological problems with MAC implementation
- Explanation of pre-averaging limitations in methods such as WEAT and MAC
- Our research and Bayesian approach
...
In the learning process word embeddings can learn implicit biases that reflect harmful stereotypical thinking
...
- Sensitive to the choice of protected words, capitalization, distance measures and embedding methods [@zhang2020robustness]
...
Suppose all similarities for two classes are randomly drawn from the same distribution, $\mathsf{Normal}(0,.05)$, you still can get really high WEAT!
...
##   Cosine distance and  connection type
...
- Introduced to the topic of bias in word embeddings
- Analysed methodological problems with MAC implementation
- Explained of pre-averaging limitations in methods such as WEAT and MAC
