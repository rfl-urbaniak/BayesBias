...
\begin{frame}{The plan of the presentation}
\protect\hypertarget{the-plan-of-the-presentation}{}
\begin{itemize}
\tightlist
\item
...
\item
  Explanation of pre-averaging limitations in methods such as WEAT and
  MAC
\item
...
In the learning process word embeddings can learn implicit biases that
...
\item
  ...
  measures and embedding methods
  (\protect\hyperlink{ref-zhang2020robustness}{Zhang, Sneyd, \&
  Stevenson, 2020})
\end{itemize}
\end{block}
\end{frame}
...
\protect\hypertarget{cosine-distance-and-connection-type}{}
...
\begin{frame}{Cosine distance and connection type}
\protect\hypertarget{cosine-distance-and-connection-type-1}{}
