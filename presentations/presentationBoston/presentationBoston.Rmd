...
## The problem with pre-averaging on real set-up

### One simulation on real set-up (no similarities and small std)
...
- The 95% of the data is in range `r round(quantile, 3)`
- `r round(absOver182*100, 2)`% of the absolute values are above 1.81


## The problem with pre-averaging on real set-up

### 10k simulations with similarity equal to 0.1
...
- The 95% of the data is in range `r round(quantiles1, 3)`
...
### 10k simulations with similarity equal to 0.4
...
- The 95% of the data is in range `r round(quantiles4, 3)`
