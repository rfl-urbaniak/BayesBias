...
- @Ethayarajh2020measuring criticizes WEAT uses Bernstein bounds and argues that we would need a bias specific dataset of size at least 11903 to claim that the system is biased (three times larger than WinoBias).
...
### No principled interpretation - visualization 1
...
### No principled interpretation - visualization 2
...
ggplot(raceReddit, aes(x = connection, y = cosine_similarity, fill = connection, color = connection))+
  ...
  ylab("similarity")+theme_tufte()+ geom_hline(yintercept = .11, color = "grey")+
  ggtitle("Race: empirical distribution of cosine similarity")+
...
### No principled interpretation - visualization 3
...
ggplot(genderReddit, aes(x = connection, y = cosine_similarity, fill = connection, color = connection))+
  ...
  ylab("similarity")+theme_tufte()+ geom_hline(yintercept = .38, color = "grey")+
  ggtitle("Gender: empirical distribution of cosine similarity")+
...
### Simple case: two pws, four terms
...
### Simulation with realistic set-up (16 predicates)
...
### 10k simulations (same parameters)
...
### 10k simulations with mean similarity  0.1
...
### 10k simulations with mean similarity  0.4
