...
\begin{block}{No principled interpretation - visualization 1}
\protect\hypertarget{no-principled-interpretation---visualization-1}{}
...
\begin{block}{No principled interpretation - visualization 2}
\protect\hypertarget{no-principled-interpretation---visualization-2}{}
...
\begin{block}{No principled interpretation - visualization 3}
\protect\hypertarget{no-principled-interpretation---visualization-3}{}
...
\begin{center}\includegraphics[width=0.7\linewidth]{presentationBoston_files/figure-beamer/unnamed-chunk-9-1} \end{center}
\normalsize
...
\begin{center}\includegraphics[width=0.7\linewidth]{presentationBoston_files/figure-beamer/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{presentationBoston_files/figure-beamer/unnamed-chunk-12-1} \end{center}
\vspace{1mm}
\footnotesize
...
\begin{center}\includegraphics[width=0.8\linewidth]{presentationBoston_files/figure-beamer/unnamed-chunk-14-1} \end{center}
\vspace{1mm}
\footnotesize
...
\begin{center}\includegraphics[width=0.8\linewidth]{presentationBoston_files/figure-beamer/unnamed-chunk-16-1} \end{center}
\vspace{1mm}
\footnotesize
